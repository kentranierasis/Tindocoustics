...
<html lang="en">
  <head>
    ...
    <title>Shop All Guitars — TINDOC Acoustic Guitars</title>
    ...
    <link rel="stylesheet" href="css/shopstyle.css?v=3" />
  </head>
  <body>
    <!-- ============ HEADER / NAV ============ -->
    ...
    <section class="hero shop-hero">
      ...
      <div class="hero-content">
        <h1>Shop Guitars<span>Made to Inspire.</span></h1>
        <p class="hero-text">
          Explore our collection of premium acoustic guitars crafted for
          every player and every style.
        </p>
      </div>
    </section>

    <!-- ============ SHOP GRID ============ -->
    <section class="shop-section" id="shop-display">
      <div class="section-header">
        <p class="eyebrow">Our Collection</p>
        <h2>Shop All Guitars</h2>
      </div>

      <?php
      $pdo = getConnection();
      $stmt = $pdo->query("SELECT * FROM products WHERE category = 'Acoustic Guitar' ORDER BY created_at DESC");
      $guitars = $stmt->fetchAll(PDO::FETCH_ASSOC);
      ?>

      <div class="product-grid shop-grid">
        <?php foreach ($guitars as $product): ?>
    ...
    <section class="features-bar">
      <div class="feature-item">
        ...
        <h3>Free Shipping</h3>
        <p>Free delivery on all orders within the Philippines.</p>
      </div>
      <div class="feature-item">
        <i class="fa-solid fa-shield-halved"></i>
        <h3>Secure Payment</h3>
        <p>Safe and secure checkout with trusted payment options.</p>
      </div>
      <div class="feature-item">
        <i class="fa-solid fa-award"></i>
        <h3>Quality Guarantee</h3>
        <p>Every guitar is backed by our quality and craftsmanship promise.</p>
      </div>
      <div class="feature-item">
    ...
    <section class="guide-banner">
      ...
      <div class="guide-content">
        <h2>Not Sure Which Guitar<br />Is Right for You?</h2>
        <p>Browse by series, body shape, or tonewood to find your perfect match.</p>
      </div>
    </section>

    <!-- ============ FOOTER ============ -->
    <footer class="site-footer" id="contact">
      <img src="images/Contact-Design.png" alt="" class="footer-decoration" aria-hidden="true" />
      ...
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <div class="social-links">
            <a href="https://www.facebook.com/kennhaku" aria-label="Facebook" ><i class="fa-brands fa-facebook-f"></i></a>
            <a href="https://www.instagram.com/kensimpleton/" aria-label="Instagram" ><i class="fa-brands fa-instagram"></i></a>
            <a href="https://www.youtube.com/@TindocKentRanier" aria-label="YouTube" ><i class="fa-brands fa-youtube"></i></a>
            <a href="https://www.tiktok.com/@kentranier_" aria-label="TikTok" ><i class="fa-brands fa-tiktok"></i></a>
          </div>
        </div>
        ...
        <div class="footer-links">
          ...
          <ul>
            ...
            <li><a href="contact.php#faq-section" >Shipping &amp; Delivery</a></li>
            <li><a href="contact.php#faq-section">Returns &amp; Exchanges</a></li>
          </ul>
        </div>
        ...
        <div class="footer-contact">
          <h4>Contact Us</h4>
          <ul>
            <li><i class="fa-solid fa-phone"></i> <span>+63 967 634 7439</span></li>
